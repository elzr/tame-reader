    ...
    const coreSiteConfig = {
        ...
        pageTypes: [
            ...
            },
            {
                ...
                listeners: [
                    ...
                    Evergage.listener("click", "#register-01 a.btn.primary", () => {
                        ...
                        if (hasConsent && agreeTerms === "custom-checkbox-item checked" && registerEmail) {
                            Evergage.sendEvent({
                                action: "Register",
                                user: {
                                    attributes: {
            ...
            },
            {
                ...
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /^\/journals\/([a-zA-Z\-]+).*(publishing-fees|fee-policy)(([\?\#].*)?)$/.test(window.location.pathname),
                action: "View Journal Publishing Fee",
                catalog: {
                    Journal: {
                        _id: () => {
                            let href = window.location.pathname;
                            let regex = /^\/journals\/([a-zA-Z\-]+).*(publishing-fees|fee-policy)(([\?\#].*)?)$/;
                            let id = href.match(regex)[1];
                            return id;
                        },
                        name: Evergage.resolvers.fromMeta("title"),
